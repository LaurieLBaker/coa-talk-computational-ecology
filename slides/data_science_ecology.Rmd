...
### 1. Introduce you to some of the problems I find interesting.
...
```{r, echo=FALSE, out.width=400, fig.align='center', fig.cap="Fixed wing aircraft used to distribute vaccines."}
